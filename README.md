...
1. Set up the Environment: Create a new conda environment:
        ...
        conda create --name CompenNet-plusplus python=3.7
        # Activate the environment
        conda activate CompenNet-plusplus # Linux/macOS
        activate CompenNet-plusplus # Windows
2. Clone this repo:
...
4. Download CompenNet++ [benchmark dataset (~11G)][3] and extract to [`data/`](data)
...
3. [Project and capture](https://github.com/BingyaoHuang/SPAA/blob/main/src/python/utils.py#L578) the plain black `data/ref/img_0001.png` and the plain white images `data/ref/img_0125.png` for projector FOV mask detection later. Then, save the captured images to `data_root/cam/raw/ref/img_0001.png(img_0125.png)`.
